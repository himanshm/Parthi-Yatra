...
function Button({ children, to, btntype, ...props }: ButtonProps) {
  ...
  const styles: ButtonStyles = {
    primary: base + ' w-full px-3 py-2 md:px-6 md:py-4',
    small: base + ' px-1 md:px-5 md:py-2.5 text-xs',
    round: base + ' px-2.5 py-1 md:px-3.5 md:py-2 text-sm',
    secondary:
      'inline-block w-20 text-sm rounded-full border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:outline-none focus:text-stone-800 focus:ring focus:ring-stone-200 focus:bg-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed px-3 py-2 md:px-6 md:py-3.5',
    tertiary: base + ' px-3 py-2 w-20',
